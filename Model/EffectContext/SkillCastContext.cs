...
namespace FunGame.Core.Model.EffectContext
{
    ...
    public class SkillCastContext(IGamingQueue? queue, Character? caster = null) : HookContext(queue, caster)
    {
        ...
        /// 非指向性目标格子
        /// </summary>
        public List<Grid> Grids { get; internal set; } = [];

        /// <summary>
        /// 随技能传递的动态参数
        /// </summary>
        public Dictionary<string, object> Others { get; internal set; } = [];

        /// <summary>
        /// 消耗的 MP
        /// </summary>
        public double MPCost { get; internal set; } = 0;

        /// <summary>
        /// 消耗的 EP
        /// </summary>
        public double EPCost { get; internal set; } = 0;

        /// <summary>
        /// 消耗值（释放技能事件时为 EP 消耗）
        /// </summary>
        public double Cost { get; internal set; } = 0;

        /// <summary>
        /// 打断施法者
        /// </summary>
        public Character? Interrupter { get; internal set; } = null;
    }
}
