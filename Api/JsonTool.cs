...
namespace FunGame.Core.Api
{
    ...
    public class JsonTool
    {
        ...
        /// 默认的序列化选项
        /// </summary>
        public static JsonSerializerOptions JsonSerializerOptions => JsonService.GeneralOptions;
        ...
        /// <returns></returns>
        public string GetString<T>(T obj) => JsonService.GetString(obj, Options);
        ...
        /// <returns></returns>
        public T? GetObject<T>(string json) => JsonService.GetObject<T>(json, Options);
        ...
        /// <param name="json"></param>
        /// <returns></returns>
        public object? GetObject(string json) => JsonService.GetObject(json, Options);
        ...
        /// <returns></returns>
        public T? GetObject<T>(Hashtable table, string key) => JsonService.GetObject<T>(table, key, Options);
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public T? GetObject<T>(Dictionary<string, object> dict, string key) => JsonService.GetObject<T>(dict, key, Options);
        ...
        /// <returns></returns>
        public T? JsonDeserializeFromIEnumerable<T>(IEnumerable<object> e, int index) => JsonService.GetObject<T>(e, index, Options);
        ...
        /// <param name="json"></param>
        /// <returns></returns>
        public List<T> GetObjects<T>(string json) => JsonService.GetObjects<T>(json, Options);
    }
}
