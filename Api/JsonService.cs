...
using FunGame.Core.Library.Common.JsonConverter;
...
namespace FunGame.Core.Api
{
    public class JsonService
    {
        ...
        /// 默认的序列化选项
        /// </summary>
        public static JsonSerializerOptions GeneralOptions { get; } = new()
        {
            WriteIndented = true,
            PropertyNameCaseInsensitive = true,
            Encoder = JavaScriptEncoder.Create(UnicodeRanges.All),
            ReferenceHandler = ReferenceHandler.IgnoreCycles,
            Converters = { new DateTimeConverter(), new UserConverter(), new RoomConverter(),
        ...
        /// <returns></returns>
        public static string GetString<T>(T obj, JsonSerializerOptions options)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static T? GetObject<T>(ref Utf8JsonReader reader, JsonSerializerOptions options)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static T? GetObject<T>(string json, JsonSerializerOptions options)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static object? GetObject(string json, JsonSerializerOptions options)
        {
        ...
        /// <returns></returns>
        public static T? GetObject<T>(Hashtable table, string key)
        {
        ...
        /// <returns></returns>
        public static T? GetObject<T>(IEnumerable<object> e, int index)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static T? GetObject<T>(IEnumerable<object> e, int index, JsonSerializerOptions options)
        {
            IEnumerable<JsonElement> elements = e.Cast<JsonElement>();
            if (elements.Count() > index)
            {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static T? GetObject<T>(Hashtable table, string key, JsonSerializerOptions options)
        {
            if (table.ContainsKey(key))
            {
                JsonElement? element = (JsonElement?)table[key];
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static T? GetObject<T>(Dictionary<string, object> dict, string key, JsonSerializerOptions options)
        {
            if (dict.TryGetValue(key, out object? value))
            {
                JsonElement? element = (JsonElement?)value;
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public static List<T> GetObjects<T>(string json, JsonSerializerOptions options)
        {
            json = "[" + json.Replace("}{", "},{") + "]"; // 将Json字符串转换为数组
        ...
        /// <param name="json"></param>
        /// <returns></returns>
        public static bool IsCompleteJson<T>(string json)
        {
            try
            {
